...
ifneq ($(wildcard device/udoo/udoo_6sx/fstab_nand.freescale),)
$(shell touch device/udoo/udoo_6sx/fstab_nand.freescale)
endif

ifneq ($(wildcard device/udoo/udoo_6sx/fstab.freescale),)
$(shell touch device/udoo/udoo_6sx/fstab.freescale)
endif
...
PRODUCT_COPY_FILES += \
	device/udoo/udoo_6sx/audio_effects.conf:system/vendor/etc/audio_effects.conf \
